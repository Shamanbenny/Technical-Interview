...
1. Read `LeetCode/README.md` and inspect existing `LeetCode/<id>_<title>/` entries before changing anything.
...
4. Create `LeetCode/<questionFrontendId>_<title>/`, sanitizing unsafe filesystem punctuation while preserving the existing naming style.
